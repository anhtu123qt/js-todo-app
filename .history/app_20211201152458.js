...
const countTaskCompleted = document.querySelector("#count-tast-completed");
...
function showCompletedTask(index) {
    ...
    let countTaskCompleted = '';
    let count = completedTasks.length;   
    countTaskCompleted = `
                        <div class="mt-2 bg-gray-50 rounded-md w-36">
                            <span class="p-5">Completed ${count}</span>
                        </div>
                        `
    countTaskCompleted.innerHTML = countTaskCompleted
    showTasks();
}
